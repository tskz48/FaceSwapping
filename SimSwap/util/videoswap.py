        ...
        if  ret:
            ...
            if detect_results is not None:
                ...
                for frame_align_crop in frame_align_crop_list:
                    ...
                    frame_align_crop_tenor = _totensor(cv2.cvtColor(frame_align_crop,cv2.COLOR_BGR2RGB))[None,...].to(id_vetor.device)
                    ...
                    if frame_index == 0:
                        ...
                        raw_swap = (
                        np.clip(raw_swap, 0, 1) * 255
                        ).astype(np.uint8)

                        cv2.imwrite(
                        "raw_swapB.jpg",
                         cv2.cvtColor(raw_swap, cv2.COLOR_RGB2BGR),
                        )
